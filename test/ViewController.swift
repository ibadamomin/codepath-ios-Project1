...
//  test
//
//  Created by Ibad Momin on 2/2/23.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func introduceSelfDidTapped(_ sender: UIButton){
        ...
        let introduction = "Hello! My name is \(firstNameTextField.text!) \(lastNameTextField.text!) and I live in \(locationTextField.text!). I attend \(schoolNameTextField.text!). I am currently in my \(year!) year and I am studying \(majorTextField.text!). I own \(numberOfPetsLabel.text!) dogs. It is \(morePetsSwitch.isOn) that I want more pets."
